        ...
        for (var a = 0, b = this.elements.length; b > a; a++)
            (this.elements[a].lastOutput = ""),
                ...
                this.elements[a].value.length &&
                    (this.elements[a].value = this.elements[a].value.replace(
                        /\D/g,
                        ""
                    ));
    }),
        ...
        (h.toMoney = function (a, b) {
            if (((b = f(b)), b.zeroCents)) {
                ...
                var c = "(" + b.separator + "[0]{0," + b.precision + "})",
                    ...
                    g =
                        b.lastOutput.toString().replace(/[\D]/g, "").length ||
                        0;
            ...
            if (
                ((l = l.replace(i, "")), (l = l.length ? l : "0"), !b.zeroCents)
            ) {
...
VMasker(document.querySelector("#input-tel")).maskPattern("(99)99999-9999");
